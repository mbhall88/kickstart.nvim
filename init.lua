...
-- Enable true colour support for themes
...
require('lazy').setup({
...

  {
    ...
    -- Optional: add keymaps here if you want quick shortcuts
    ...
    config = function()
      ...
      require('tokyonight').setup {
        ...
        on_highlights = function(hl, c)
          local mid_grey = '#7a88b5'
          -- Brighten the relative numbers above and below the cursor
          hl.LineNrAbove = { fg = mid_grey, bold = false }
          hl.LineNrBelow = { fg = mid_grey, bold = false }

          -- Fallback just in case you ever disable relative numbers
          hl.LineNr = { fg = c.fg_dark, bold = true }
        end,
      }
